 ...
 *
 * The followings are the available columns in table 'tbl_rule':
 * @property integer $id
...
class Rule extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, starts, ends, discipline, owner, property', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, starts, ends, discipline, owner, property, isPrivate', 'safe', 'on'=>'search'),
		);
	}
